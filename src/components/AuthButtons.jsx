...
export const SingInButton = () => {
  return (
    <button
      ...
      className="m-auto flex items-center justify-center rounded-lg bg-white px-20 py-2 text-center text-base font-semibold text-gray-700 shadow-md transition duration-200 ease-in hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200"
    >
      <svg
        viewBox="0 0 24 24"
        height="25"
