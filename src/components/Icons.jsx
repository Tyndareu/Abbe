export const FixedDateIcon = () => {
  return (
    <svg baseProfile="tiny" viewBox="0 0 24 24" fill="red" height="2em">
...
export function IconBxTask() {
  return (
    <svg viewBox="0 0 24 24" fill="#3b82f6" height="1.6em">
...
export function ClockHistoryIcon() {
  return (
    <svg fill="currentColor" viewBox="0 0 16 16" width="23">
...
export function UpdateIcon() {
  return (
    <svg fill="none" viewBox="0 0 15 15" width="23">
      <path
        fill="currentColor"
        fillRule="evenodd"
...
export function IconDeleteBin5Fill() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" height="2.5em">
...
export function IconArrowBackUp() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
